...
export default async function ServiceAreasDirectoryPage() {
  ...
  return <div className="bg-white min-h-screen">
    <PageHero imageSrc="/assets/hero-service-areas.jpg" imageAlt="PipeFlow technician arriving at a Colorado home" eyebrow="Regional Colorado Coverage" eyebrowIcon={MapPin} title="Serving Colorado homeowners across the Front Range." description="Check availability and find your community below." primaryCta={{ label: 'Find a Specialist', href: '#service-area-checker', variant: 'red', icon: Search }} secondaryCta={{ label: 'Call Dispatch Direct', href: `tel:${siteConfig.company.phone}`, variant: 'outline', icon: Phone, isExternal: true }} badgeText="Active PipeFlow service locations" />
